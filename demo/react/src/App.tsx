...
const extensions = [TextStyleKit, StarterKit, SearchReplacePlugin];
  ...
  return (
    <div className="control-group">
      ...
      <div className="input-group">
        ...
        <Button onClick={() => editor.chain().focus().findNext().run()}>Next</Button>
        <Button onClick={() => editor.chain().focus().findPrevious().run()}>Previous</Button>
        <Button onClick={() => editor.chain().focus().replace(replace).run()}>Replace</Button>
        <Button onClick={() => editor.chain().focus().replaceAll(replace).run()}>ReplaceAll</Button>
        <Button onClick={() => editor.chain().focus().closeFindReplace().run()}>Clear</Button>
      </div>
    </div>
  );
}
